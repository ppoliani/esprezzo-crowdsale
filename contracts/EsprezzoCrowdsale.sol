...
contract EsprezzoCrowdsale is RefundableCrowdsale, MintedCrowdsale, CappedCrowdsale {
    ...
    // Token Distribution
    // =============================
    uint256 public maxTokens          = 500000000000000000000000000; // 500 mil
    uint256 public tokensForEcosystem = 100000000000000000000000000; // 100 mil
    uint256 public tokensForTeam      = 100000000000000000000000000; // 100 mil
    uint256 public tokensForBounty    = 45000000000000000000000000;  // 45 mil
    uint256 public totalTokensForSale = 255000000000000000000000000; // 255 mil
    uint256 public totalTokensForSaleDuringPreICO = 150000000000000000000000000; // 150 mil
    // ==============================
